...
import com.thetestingacademy.ATB9xSeleniumAdavanceFramework.listeners.RetryAnalyzer;
...
public class TestVWOLogin_07_Improved_POM_PropertiesReader_DriverManager_Retry extends CommonToAllTest{
	    ...
	    @Description("Verify that valid creds dashboard page is loaded")
	    @Test
	    public void testLoginPositiveFailVWO() {
		        ...
		        assertThat(usernameLoggedIn).isNotBlank().isNotNull().isNotEmpty();
		        Assert.assertEquals(usernameLoggedIn,PropertiesReader.readKey("Febil"));
	    }
}